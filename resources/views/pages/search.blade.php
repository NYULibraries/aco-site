    ...
    <header class="results-header">
      ...
      <div class="aboutinfo">
        <div class="aboutinfo-links">
          <a href="#" dir="ltr" lang="en" class="aboutinfo-link aboutinfo-link-available"><span></span>About this search</a>
          <a href="#" dir="rtl" lang="ar" class="aboutinfo-link aboutinfo-link-available">بخصوص هذا البحث<span class="arrow-left"></span></a>
        </div>
      ...
      <div class="resultsnum">Showing <span class="start">{{ $startIndex }}</span> - <span class="docslength">{{ $endIndex }}</span> of <span class="numfound">{{ $numfound }}</span> <span class="resultsfor">results for</span> <span class="s-query">{{ $query }}</span></div>
          ...
          <div class="md_publisher">
            ...
            @if (!empty($item['en']['publishers']))
              @foreach ($item['en']['publishers'] as $publisher)
                @if (!empty($publisher))
                  <span><a class="md_publisher" href="{{ url($publisher['path']) }}">{{ $publisher['label'] }}</a></span>
                @else
                  n.p.
                @endif
              @endforeach
