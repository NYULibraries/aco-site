...
@section('content')
  <main class="main container-fluid" role="main">
    ...
    <div class="col col-l" lang="en" dir="ltr">
      ...
      <a href="{{ route('about.index') }}" aria-label="read more about Arabic Collections Online" class="readmore">READ&nbsp;MORE…</a>
    </div>
    <div class="col col-r" lang="ar" dir="rtl">
      ...
      <a aria-label="read more about Arabic Collections Online" href="{{ route('about.index') }}" class="readmore">المزيد...</a>`
    </div>
    @if (isset($documents))
