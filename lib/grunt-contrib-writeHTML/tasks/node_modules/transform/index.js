module.exports = async function (configuration) {
  ...
  try {
    ...
    let source = require(projectConfigurationFile);
    ...
    var pages = configuration.data.pages;
    // remove pages from configuration.data object
    delete(configuration.data.pages);

    /** copy all of the page properties in the source */
    // _.extend(source, configuration.data); Looks like this was a HUUUGEEE bug the likes no one has seen before
    source = _.extend(configuration.data, source);
    ...
    _.each (HandlebarsHelpers(), (helper, key) => { Handlebars.registerHelper(key, helper) });
